DeleteStudent Program This project is a small Java application that connects to an Oracle XE database and allows you to delete a student record by entering the student’s ID.

Requirements Oracle XE installed and running
...
Setup Steps Install Oracle XE and make sure the database service is running.
...
How It Works When you run the program, it asks you to enter a student ID.
...
Notes Make sure the database is running before you execute the program.
